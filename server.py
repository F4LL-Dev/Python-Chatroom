    ...
    while True: 
        try: 
            ...
            if client in clients:
                ...
                broadcast_msg(
                    f'{nickname} has left the chat.'.encode('ascii'))
...
def receive():
    while True: 
        ...
        broadcast_msg(f'{nickname} has just joined the chat !'.encode('ascii'))
        client.send(f'Successfully Connected to Server '.encode('ascii'))
...
def kick_user(name):
    if name in nicknames:
        ...
        broadcast_msg(f'{name} was kicked by an admin'.encode('ascii'))
